  ...
  return (
    ...
    <div className=" min-h-screen flex flex-col justify-center lg:px-32 px-5 ">
      <div className=" flex flex-col items-center lg:flex-row justify-between mb-10 lg:mb-0">
        <div>
          <h1 class="our" className=" text-4xl font-semibold text-center  lg:text-start">
            Our Doctors
          </h1>
          <p class="at" className=" mt-2 text-center lg:text-start">
          At WellnessVista, our team of skilled and compassionate doctors is dedicated to providing exceptional healthcare to our patients.
          </p>
        </div>
